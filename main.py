...
def get_discount(u: dict) -> int:
    ...
    # Скидка от угощений (старые баффы)
...
async def shear(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Проверяем бафф от совы (wool_boost)
...
def main():
    ...
    # Обработчики для оплаты фруктами
