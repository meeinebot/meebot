...
def check_fire(user_id):
    ...
    # Уменьшаем огонь на количество минут
...
def check_game_status(user_id):
    ...
    # Проверка сытости (только если прошла минута)
